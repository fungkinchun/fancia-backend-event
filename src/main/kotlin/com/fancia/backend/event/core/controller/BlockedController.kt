...
import com.fancia.backend.event.core.service.BlockedResourceService
...
@Tag(name = "Blocked resources", description = "Hide events")
...
class BlockedController(
    ...
    @GetMapping
    @Operation(summary = "List hidden events for the current user")
    fun list(
