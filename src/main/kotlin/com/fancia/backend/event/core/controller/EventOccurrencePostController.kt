...
class EventOccurrencePostController(
    private val eventOccurrencePostService: EventOccurrencePostService,
) {
    @Operation(
    ...
    fun createPost(
        ...
        val post = eventOccurrencePostService.create(eventId, occurrenceId, request, jwt)
    ...
    fun updatePost(
        ...
        return ResponseEntity.ok(eventOccurrencePostService.update(eventId, occurrenceId, postId, request, jwt))
    }
    ...
    fun likePost(
        ...
        eventOccurrencePostService.like(eventId, occurrenceId, postId, jwt)
